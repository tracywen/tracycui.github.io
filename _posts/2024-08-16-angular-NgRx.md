---
title: Angular NgRx
description: 深入了解NgRx的优势
categories: [Angular]
mermaid: true,
media_subpath: '/assets/img/posts/ngrx'
---
...
![state management](ngrx-state.png)
...
![state management](ngrx-selector.png)
...
component 代码如下：
![state management](ngrx-component.png)

html 页面代码如下：
![state management](ngrx-component-view.png)
...
![state management](ngrx-action.png)


## effects
所有的异步操作，比如常用的 API call，需要放在 effects 里，我们来看下具体代码写法：

![state management](ngrx-effects.png)
...
![state management](ngrx-reducer.png)
...
![state management](ngrx-action-trigger.png)
